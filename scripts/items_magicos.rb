...
#input_filenames = ['weapons_magical_basic_set.xlsx', 'armour_magical_basic_set.xlsx', 'misc_magical_basic_set.xlsx']
...
# ===== BUILDING FRONT =====
# has artwork, doesnt have description
input_filenames.each do |filename|
  data = Squib.xlsx file: filename 
  Squib::Deck.new cards: data['name'].size, layout: 'card_layout.yml', width: 750, height: 1050 do
    ...
    svg file: data['artwork'], layout: 'artwork_large', height: :scale
...
#rect layout: 'text_full'
    ...
    save_pdf file: "#{File.basename(filename, '.xlsx')}_front.pdf", dir: $output_dir, width: '210mm', height: '297mm'
  end

end

# ===== BUILDING BACKSIDE ======
# has description, doesnt have artwork
curr_card_count = 0
...
#rect layout: 'text_full'
    ...
    #save_png prefix: File.basename(filename, 'xlsx'), dir: $output_dir
    #save_sheet prefix: File.basename(filename, 'xlsx'), dir: $output_dir 
    save_pdf file: "#{File.basename(filename, '.xlsx')}_back.pdf", dir: $output_dir, width: '210mm', height: '297mm'
  end
