...
input_filenames = ['ferimentos_criticos_basic_set.xlsx']
...
input_filenames.each do |filename|
  ...
  Squib::Deck.new cards: data['name'].size, layout: 'card_layout.yml', width: 750, height: 1050 do
    ...
    rect layout: 'border_inner', fill_color: 'black'
    ...
    text(str: data['type_icon'], layout: 'type_icon', color: :white) do |embed|
    ...
    text str: data['info'], layout: 'info', color: :white
