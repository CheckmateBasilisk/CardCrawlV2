...
input_filenames = ['planos_basic_set.xlsx']
...
input_filenames.each do |filename|
  ...
  Squib::Deck.new cards: data['name'].size, layout: 'card_layout.yml', width: 750, height: 1050 do
    ...
    #data['artwork'].map! {|i| "#{$artwork}#{i}"} #TODO: think about where to put artwork
    ...
    text(str: data['type_icon'], layout: 'type_icon') do |embed|
      ...
      embed.svg key: 'plan', file: $iconography+'pentacle.svg', layout: 'type_icon'
    ...
    text(str: data['text'], layout: 'text_full', markup: true) do |embed|
      ...
      embed.svg key: ':damage_magic:', file: $iconography+'lightning-helix.svg', layout: 'icon_text'
